    ...
    $_SESSION['游戏世界'] = [
        ...
        '地图' => [
            '村庄广场' => [
                ...
                '出口' => ['东' => '铁匠铺', '西' => '小酒馆', '北' => '森林入口', '南' => '村口大门'],
                '物品' => ['旧报纸'],
                '人物' => ['村长' => '一位白发苍苍的老人正在广场中央的长椅上休息'],
                '脚本' => '
                if (isset($_SESSION["游戏状态"]["任务"])) {
            ...
            '铁匠铺' => [
                ...
                '出口' => ['西' => '村庄广场'],
                '物品' => ['铁锤'],
                '人物' => ['铁匠' => '一位肌肉发达的中年男子，正用钳子夹着一块烧红的铁'],
                '特殊' => '需要钥匙打开铁匠的箱子',
                '脚本' => '
                if (物品在背包中("黄金项链")) {
                    echo "\n铁匠不时瞥向你，似乎对你的项链很感兴趣。";
            ...
            '小酒馆' => [
                ...
                '出口' => ['东' => '村庄广场', '上' => '酒馆二楼'],
                '物品' => ['空酒杯'],
                '人物' => ['酒保' => '一个秃顶的胖男人，正在擦拭酒杯'],
                '脚本' => '
                if (!isset($_SESSION["游戏状态"]["已访问地点"]["酒馆二楼"])) {
                    echo "\n酒保偶尔抬头看向二楼，似乎在担心什么。";
                }'
            ],
            '酒馆二楼' => [
        ...
        '数据' => [
            '物品数据' => [
                ...
                '草药' => [
                    ...
                    '使用效果' => '
                        $_SESSION["游戏状态"]["生命值"] = min(100, $_SESSION["游戏状态"]["生命值"] + 20);
                        移除物品("草药");
                        return "你使用了草药，恢复了20点生命值！";
                    ',
                    '最大数量' => 3, // 最多可以拾取3个
                    '使用次数' => null // 可以无限使用(只要背包里有)
                ],

                '火把' => [
                    '使用效果' => '
                        if ($_SESSION["游戏状态"]["当前位置"] === "森林深处") {
